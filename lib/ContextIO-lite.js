                ...
                messages: function() {
                  ...
                  return {
                    ...
                    attachments: function() {
                      _resourcePath += _messageId + '/attachments/';
                      var _attachmentId = (typeof arguments[0] == 'string') ? arguments[0] : '';
                      return {
                        get: function () {
                          _doCall.call(_obj, 'GET', _resourcePath + _attachmentId, null, _parseArgs(arguments).cb);
                        },
                      }
                    },
                    flags: function () {
                    ...
                    headers: function () {
                      if (!_messageId) return null;
                      _resourcePath += _messageId+'/headers/';
                      return {
                        get: function () {
                          var _args = _parseArgs(arguments);
                          _doCall.call(_obj, 'GET', _resourcePath, _args.params, _args.cb);
